                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () => Navigator.of(context)
                          .pushNamed(RECOVER_PASSWORD_PAGE_ROUTE),
                        ...
                        children: [
                          RareGemPrimaryOutlineButton(
                            ...
                            onClick: () => Navigator.of(context)
                                .pushNamed(ALREADY_LOGGEDIN_PAGE_ROUTE),
                          ),
                          RowSpace(16),
                          RareGemPrimaryOutlineButton(
                            child: Icon(Icons.golf_course, color: primaryColor),
                            onClick: () => Navigator.of(context)
                                .pushNamed(VERIFY_ACCOUNT_PAGE_ROUTE),
                          ),
                        ],
                      ),
                      ColumnSpace(24),
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () => Navigator.of(context)
                                    .pushNamedAndRemoveUntil(
                                        REGISTER_PAGE_ROUTE, (route) => false),
                            )
                          ]),
                        ),
                      ),
