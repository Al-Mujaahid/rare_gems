...
class GoldWalletBalance extends StatelessWidget {
  const GoldWalletBalance({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("Gold Wallet", style: interTextStyle.copyWith(
                  ...
                  Expanded(
                    child: RichText(
                      text: TextSpan(
                          children: [
                            TextSpan(
                                text: '${goldFormat.format(value.goldBalance)}',
          ...
          ColumnSpace(20),
          InkWell(
            onTap: () => Navigator.of(context).pushNamed(TRANSACTION_HISTORY_ROUTE, arguments: 'gold'),
            child: Row(
              children: [
