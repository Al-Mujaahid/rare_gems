...
class AddFundAmountToFund extends StatelessWidget {
  const AddFundAmountToFund({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ColumnSpace(17),
            Text("Amount to fund", style: sfProTextStyle.copyWith(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text('Amount to deposit in $CURRENCY_SYMBOL', style: subtitleStyle, textAlign: TextAlign.left,),
                  TextFormField(
                    onChanged: (String text) => print(text),
                    decoration: underlineInputDecoration(filled: false, hintText: 'Enter amount to fund in $CURRENCY_SYMBOL'),
                  ),
                ],
              ),
            ),
            ...
            RareGemPrimaryButton(
              ...
              onClick: () => Navigator.of(context).pushNamed(ADD_FUND_SUMMARY_ROUTE),
            ),
            ColumnSpace(40),
